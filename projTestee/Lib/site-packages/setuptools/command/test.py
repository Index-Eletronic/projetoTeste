...
class test(Command):
    """Command to run unit tests after in-place Tibia"""

    description = "run unit tests after in-place Tibia (deprecated)"
    ...
    def run_tests(self):
        ...
        # re-import them from the Tibia location. Required when 2to3 is used
